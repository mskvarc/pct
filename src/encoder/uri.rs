...
impl Encoder for UriReserved {
    ...
    fn ascii_keep_lo_shuf(&self) -> Option<&'static [u8; 16]> {
        Some(match self {
            Self::Any => &URI_LO_SHUF_ANY,
            Self::Path => &URI_LO_SHUF_PATH,
            Self::Query => &URI_LO_SHUF_QUERY,
            Self::Fragment => &URI_LO_SHUF_FRAGMENT,
        })
    }
}
...
pub(crate) static URI_LO_SHUF_ANY: [u8; 16] = crate::scan::build_lo_shuf(&URI_KEEP_ANY);
pub(crate) static URI_LO_SHUF_PATH: [u8; 16] = crate::scan::build_lo_shuf(&URI_KEEP_PATH);
pub(crate) static URI_LO_SHUF_QUERY: [u8; 16] = crate::scan::build_lo_shuf(&URI_KEEP_QUERY);
pub(crate) static URI_LO_SHUF_FRAGMENT: [u8; 16] = crate::scan::build_lo_shuf(&URI_KEEP_FRAGMENT);
